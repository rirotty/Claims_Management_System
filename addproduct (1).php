                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " method="POST">
                               ...
                               <?php
                                   $clients=ViewClients($con);
                                  $n=count($clients);   
                               $res= '<div class="form-group">
                                  <label for="select3" class="col-sm-3 control-label">Client : <span class="required" style="color:red;">*</span></label>
                                          <div class="col-sm-9">
                                             
                                              <select name="productclientId" class="form-control" id="select3" required="required"><option>Search Clients</option>';
                                       if ($n>0){
                                       $num=1;       
                              foreach ($clients as $client) 
                            {$res .='<option value="'.$client['userId'].'">'.$client['userFirstname'].' '.$client['userLastname'].'</option>';
                                       $num++;}}
                                       else {$res .='<option value="Please add clients first">Please add clients first</option>';}
                         ...
                         else {$data .='<option value="Please add modules first">Please add modules first</option>
                                 </br>';}
                                     
                         $data .= '</select><a href="#" id="add">add &gt;&gt;</a></div><div class="col-sm-4"><select id="select2"class="form-control" name="modules[]" multiple></select><a href="#" id="remove">&lt;&lt; remove</a></div></div><br>'; 
                         echo $data;
                         ...
                         ?>
                                  ...
                                  <br>     
                                          ...
                                          <center><input type="submit" class="btn btn-primary"  name="addproduct" value="Save"/></center>
                              </form>
                          </div>
                      </section>
                  </div>
