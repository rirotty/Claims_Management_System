            ...
            <div>
               <?php  if(isset($_GET['con'])){
                        echo ' <div class="alert alert-block alert-danger fade in">
                                  ...
                                  <center><i class=" icon_error-triangle"></i>
                                  <strong> Please enter both your username and your password.</strong>
                                  <center></div>' ; 
                }  ?>
                <?php  if(isset($_GET['cnx'])){
                        echo ' <div class="alert alert-block alert-danger fade in" style="width: 9em;position:relative;left:30%;">
                                  <button data-dismiss="alert" class="close close-sm" type="button" >
                                  </button>
                                  <center><i class=" icon_error-triangle"></i>
                                  <strong> Unvalid user</strong>
                                  </center></div>' ; 
                }  ?> 
            </div>
