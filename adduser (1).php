                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " method="POST">
                                          ...
                                          <div class="form-group">
                                              <label for="userName" class="col-sm-3 control-label">Username : <span class="required" style="color:red;">*</span></label>
                                          <div class="col-sm-9">
                                              <input type="text" id="userName" class="form-control" name="userName" value="" required="required" />
                                         <span id="availibility"></span>
                                          ...
                                          <div class="col-sm-9">
                                              <input type="password" id="password" class="form-control" name="userPassword" value="" required="required"/>
                                          </div>
                                          </div>
                                          ...
                                          <div class="col-sm-9">
                                              <input   onChange="checkPassword()" id="confirmPassword" type="password" class="form-control" name="confirmPassword" value="" required="required"/>
                                              <div id="divcheckPassword"></div>
                                          </div>
                                          </div>
                                  
                                          <div class="form-group">
                                          <label for="userRole" class="col-sm-3 control-label">Role : <span class="required" style="color:red;">*</span></label>
                                          <div class="col-sm-9">
                                              <select id="userRole" class="form-control m-bot15" name="userRole" required="required">
                                          ...
                                          <div class="col-sm-9">
                                          <input id="userFirstname" type="text" class="form-control" name="userFirstname" value=""/>
                                          </div>
                                          </div>
                                          ...
                                          <div class="col-sm-9">
                                          <input id="userLastname" type="text" class="form-control" name="userLastname" value=""/>
                                          </div>
                                          </div>
                                          ...
                                          <div class="col-sm-9">
                                          <input  id="userAddress" type="text" class="form-control" name="userAddress" value=""/>
                                          </div>
                                          </div>
                                          <br>
                                          ...
                                          <center><input type="submit" class="btn btn-primary"  name="adduser" value="Save"/></center>
                              </form>
                          </div>
                      </section>
                  </div>
