                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " method="POST" action="connect.php">
                                          ...
                                          <div class="col-sm-10">
                                          <input type="text" class="form-control" name="userFirstname" value="<?php echo $_GET['userFirstname']?>"/>
                                          </div>
                                          </div>
                                          ...
                                          <div class="col-sm-10">
                                          <input type="text" class="form-control" name="usserLastname" value="<?php echo $_GET['userLastname']?>"/>
                                          </div>
                                          </div>
                                          ...
                                          <div class="col-sm-10">
                                          <input type="text" class="form-control" name="userEmail" value="<?php echo $_GET['userEmail']?>"/>
                                          </div>
                                          </div>
                                          ...
                                          <div class="col-sm-10">
                                          <input type="text" class="form-control" name="userAddress" value="<?php echo $_GET['userAddress']?>"/>
                                          </div>
                                          </div>
                                          <br>
                                          ...
                                          <center><input class="btn btn-primary" style="width:100px;" value="Edit" name="edituser" type="submit"/></center>
                              </form>
                          </div>
                      </section>
                  </div>
