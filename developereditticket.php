                          ...
                          <div class="panel-body">
                              ...
                              <form class="form-horizontal " method="POST" enctype="multipart/form-data" >
                                          ...
                                          <div class="col-sm-9">
                                           ...
                                           <div class="form-group">
                                  <label for="ticketassignedTo" class="col-sm-3 control-label">Assigned to : </label>
                                          <div class="col-sm-9">
                                              <input id="ticketassignedTo" type="text" class="form-control" name="ticketassignedTo" value="<?php echo $_GET['ticketassignedTo'] ;?>" readonly/>
                                              </div></div>
                                          ...
                                          <select id="ticketStatus" class="form-control" name="ticketStatus" >
                                              ...
                                              <option value="CLOSED">Close and send message</option>
                                              <option value="CLOSED">Close and send patch</option>
                                          </select>
                                          </div>
                                          </div>
                                  <div class="form-group" id="message">
                                          ...
                                          <label for="file" class="col-sm-3 control-label">Send patch :</label>
                                          <div class="col-sm-9">
                                          ...
                                          <div class="col-sm-9">
                                              <input id="ticketopeningDate" type="text" class="form-control" name="ticketopeningDate" value="<?php echo $_GET['ticketopeningDate'] ;?>" readonly/>
                                          </div>
                                          </div>
                                          ...
                                          <?php echo'<a href="'.$_GET['ticketAttachment'].'" onclick="return openWindow(this.href)"> <input name="ticketAttachment" type=text value="'.$_GET['ticketAttachment'].'" placeholder="Attachment" readonly> </a>' ?>
                                           ...
                                           <div class="form-group">
                                          <label for="ticketImportance" class="col-sm-3 control-label">Impact :</label>
                                          <div class="col-sm-9">
                                          <select id="ticketImportance" class="form-control" name="ticketImportance" >
                                              <option value="">Select</option>
                                              <option value="0.01">Small</option>
                                  ...
                                  <br>
                                          ...
                                          <center><input type="submit" class="btn btn-primary"  name="closeticket" value="Save"/></center>
                              </form>
                          </div>
                      </section>
                  </div>
...
function toggleFields() {
    if ($("#ticketStatus :selected").text() === "Close and send message"){
        $("#patch").hide();
        $("#message").show();
    }
    else if ($("#ticketStatus :selected").text() === "Close and send patch")
