        ...
        <div id="mCSB_1" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical_horizontal mCSB_outside" tabindex=0>
          ...
          <ul class="main-menu">
           ...
           echo '<li class=""><a href="products.php"><i class="icon_tags_alt"> </i> Products</a></li>' ;}?>
            <?php if ($_SESSION['userRole']=='ADMIN'){
            echo ' <li class="active"><a href="modules.php"><i class="icon_folder-add_alt"> </i> Modules</a></li>'; } ?>
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " method="POST" action="connect.php">
                                          ...
                                          <div class="form-group">
                                              <label for="moduleName" class="col-sm-3 control-label">Module name : <span class="required" style="color:red;">*</span></label>
                                          <div class="col-sm-9">
                                              <input type="text" id="moduleName" class="form-control" name="moduleName" value="" required="required" />
                                          ...
                                          <center><input type="submit" class="btn btn-primary"  name="addmodule" value="Save"/></center>
                              </form>
                          </div>
                      </section>
                  </div>
